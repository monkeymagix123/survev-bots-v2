 ...
 * Legacy monolithic bot controller (Plan 3 gunplay era) kept to compare outputs
 * against the refactored Brain/Systems architecture.
 *
 * This should be deleted once parity is validated.
 */
export class LegacyBotController {
    private _time = 0;
    ...
    step(dt: number): {
        ...
        return { msg, aimAngleRad: this._aimAngleRad, targetAngleRad: this._targetAngleRad };
    }
